...
export const navData = [
    { id: 101, title: "Home", href: "#home"},
    { id: 102, title: "Features", href: "#features"},
    { id: 103, title: "Account", href: "#account"},
    { id: 104, title: "Reviews", href: "#reviews"},
];
  ...
  export const reviews = [
    {
      ...
      body: "I downloaded Trusted Future today and turned $5000 into $25,000 in half an hour.",
      author: "udeh franklin",
      rating: 5,
    },
    {
      title: "You need this app.",
      body: "I did not understand the stock market at all before Trusted Future. I still do not, but at least I am rich now.",
      author: "Basil kosisochukwu",
      rating: 5,
    },
    {
      title: "This should not be legal.",
      body: " makes Trusted Future it so easy to win big in the stock market that I can not believe it is actually legal.",
      author: "uche fred",
      rating: 4,
    },
    {
    ...
    },
    {
      ...
      author: "chidera nduka",
      rating: 5,
    },
    {
      title: "No more debt!",
      body: "After 2 weeks of trading on Trusted Future  I was debt-free. Why did I even go to school at all when Investa exists?",
      author: "ibrahim Adamu",
      rating: 1,
    },
    {
      title: "I am 13 and I am rich.",
      body: "I love that with Trusted Future transaction anonymization I could sign up and start trading when I was 12 years old. I had a million dollars before I had armpit hair!",
      author: "Bankuli",
      rating: 5,
    },
    {
      title: "Started an investment firm.",
      body: "I charge clients a 3% management fee and just throw all their investments into Trusted Future. Easy money!",
      author: "Angela stones",
      rating: 5,
    },
    {
      title: "It is like a superpower.",
      body: "Every tip Trusted Future has sent me has paid off. It is like playing Blackjack but knowing exactly what card is coming next!",
      author: "okafor chidi",
      rating: 4,
    },
    {
      title: "Quit my job.",
      body: "I downloaded Trusted Future three days ago and quit my job today. I can not believe no one else thought to build a stock trading app that works this way!",
